...
def draw_boxes_on_image(image_path, boxes_and_conf):
    ...
    output_path = "/Users/liammckenna/vit-ai/api/vit-api/tests/gpu_tests/results/grounding_output.jpg"
...
def call_endpoint(image_path):
    ...
    endpoint_url = "https://liam-mckenna04--dino-inference-dev.modal.run"
